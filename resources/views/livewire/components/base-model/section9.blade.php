        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="flex items-center space-x-4">
                    <div class="w-10 h-10 rounded-lg border-2 border-gray-300 shadow-sm overflow-hidden cursor-pointer hover:border-gray-400 transition-all duration-200" style="background-color: {{ $section_9_bg_color }};" wire:key="bg-color-{{ $section_9_bg_color }}">
                        <input type="color" wire:model.live="section_9_bg_color" class="opacity-0 w-full h-full cursor-pointer">
                    </div>
                    <div class="flex-1">
                        <div class="bg-gray-50 rounded-lg p-3 border border-gray-200 h-10 flex items-center">
                            <p class="text-sm font-medium text-gray-700">Selected Color: <span class="font-mono text-sm text-gray-600">{{ $section_9_bg_color }}</span></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 gap-4">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 rounded-lg border-2 border-gray-300 shadow-sm overflow-hidden cursor-pointer hover:border-gray-400 transition-all duration-200" style="background-color: {{ $section_9_rect1_title_font_color }};" wire:key="rect1-title-color-{{ $section_9_rect1_title_font_color }}">
                                <input type="color" wire:model.live="section_9_rect1_title_font_color" class="opacity-0 w-full h-full cursor-pointer">
                            </div>
                            <div class="flex-1">
                                <div class="bg-gray-50 rounded-md p-2 border border-gray-200 h-10 flex items-center">
                                    <p class="text-xs font-mono text-gray-600">{{ $section_9_rect1_title_font_color }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-5 gap-4">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Color</label>
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 rounded-lg border-2 border-gray-300 shadow-sm overflow-hidden cursor-pointer hover:border-gray-400 transition-all duration-200" style="background-color: {{ $section_9_rect2_text_font_color }};" wire:key="rect2-text-color-{{ $section_9_rect2_text_font_color }}">
                                <input type="color" wire:model.live="section_9_rect2_text_font_color" class="opacity-0 w-full h-full cursor-pointer">
                            </div>
                            <div class="flex-1">
                                <div class="bg-gray-50 rounded-md p-2 border border-gray-200 h-10 flex items-center">
                                    <p class="text-xs font-mono text-gray-600">{{ $section_9_rect2_text_font_color }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="border-t border-gray-200 pt-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="section_9_button_link" class="w-full rounded-lg border border-gray-300 px-4 h-10 focus:outline-none focus:ring-2 focus:ring-cyan-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Button Icon URL</label>
                        <input type="url" wire:model="section_9_button_icon_url" class="w-full rounded-lg border border-gray-300 px-4 h-10 focus:outline-none focus:ring-2 focus:ring-cyan-500">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-6 gap-4">
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 rounded-lg border-2 border-gray-300 shadow-sm overflow-hidden cursor-pointer hover:border-gray-400 transition-all duration-200" style="background-color: {{ $section_9_button_bg_color }};" wire:key="button-bg-color-{{ $section_9_button_bg_color }}">
                                <input type="color" wire:model.live="section_9_button_bg_color" class="opacity-0 w-full h-full cursor-pointer">
                            </div>
                            <div class="flex-1">
                                <div class="bg-gray-50 rounded-md p-2 border border-gray-200 h-10 flex items-center">
                                    <p class="text-xs font-mono text-gray-600">{{ $section_9_button_bg_color }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="w-10 h-10 rounded-lg border-2 border-gray-300 shadow-sm overflow-hidden cursor-pointer hover:border-gray-400 transition-all duration-200" style="background-color: {{ $section_9_button_font_color }};" wire:key="button-font-color-{{ $section_9_button_font_color }}">
                                <input type="color" wire:model.live="section_9_button_font_color" class="opacity-0 w-full h-full cursor-pointer">
                            </div>
                            <div class="flex-1">
                                <div class="bg-gray-50 rounded-md p-2 border border-gray-200 h-10 flex items-center">
                                    <p class="text-xs font-mono text-gray-600">{{ $section_9_button_font_color }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
