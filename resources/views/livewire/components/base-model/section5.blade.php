    ...
    <div class="p-6">
        ...
        <div class="space-y-6">
            ...
            <div class="flex justify-end pt-6 border-t border-gray-200">
                <button type="button" wire:click="updateSection5" class="inline-flex items-center px-4 py-2 bg-teal-600 hover:bg-teal-700 text-white font-medium text-sm rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-teal-500 cursor-pointer h-10">
